  ...
  if(readByte(MPU6050_ADDRESS, INT_STATUS) & 0x01) {  // check if data ready interrupt
   ...
   MadgwickQuaternionUpdate(ax, ay, az, gx*PI/180.0f, gy*PI/180.0f, gz*PI/180.0f);
    ...
    { // update LCD once per half-second independent of read rate
        ...
        Serial.print("q0 = "); Serial.print(q[0], 4); Serial.print('\t');
        Serial.print("qx = "); Serial.print(q[1], 4); Serial.print('\t');
        Serial.print("qy = "); Serial.print(q[2], 4); Serial.print('\t');
        Serial.print("qz = "); Serial.println(q[3], 4);
