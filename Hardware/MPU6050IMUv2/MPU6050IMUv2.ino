...
//        }
//
//        if (qBias2 > 0 && counter ==10){
//          q[2] -= qBias2;
//        }
//        else {
//          q[2] += abs(qBias2 && counter ==10);
//        }
//
//        if (qBias3 > 0 && counter ==10){
//          q[3] -= qBias3;
//        }
//        else {
//          q[3] += abs(qBias3 && counter ==10);
//        }
        
//         Serial.print("Delta T:"); Serial.println(deltat, 4);
        Serial.print("q0 = "); Serial.print(q[0], 3); Serial.print('\t');
        Serial.print("qx = "); Serial.print(q[1], 3); Serial.print('\t');
        Serial.print("qy = "); Serial.print(q[2], 3); Serial.print('\t');
        Serial.print("qz = "); Serial.println(q[3], 3);
//         Serial.print('\t');
//         Serial.println("");
